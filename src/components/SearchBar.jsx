...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    <form
      ...
      className="search-container mx-auto flex items-center space-x-2"
    >
      <label
      ...
      <button
        type="submit"
        className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
      >
        Query
      </button>
    </form>
